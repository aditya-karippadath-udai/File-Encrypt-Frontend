  ...
  return (
    ...
    >
      <div className="space-y-4">
        {/* File Header card */}
        <div className="p-3.5 bg-[#090D12] border border-slate-800 rounded-xl flex items-center gap-3">
        ...
        <div className="grid grid-cols-2 gap-3 text-xs">
          <div className="p-3 bg-[#090D12] border border-slate-800/80 rounded-lg space-y-1">
            <div className="text-slate-500 flex items-center gap-1.5 font-medium">
              <Folder className="w-3.5 h-3.5" /> Source Location
            </div>
            <div className="font-mono text-slate-300 truncate" title={path}>
              {path || '~/Documents'}
            </div>
          </div>
          ...
          <div className="p-3 bg-[#090D12] border border-slate-800/80 rounded-lg space-y-1">
            <div className="text-slate-500 flex items-center gap-1.5 font-medium">
              <Cpu className="w-3.5 h-3.5" /> Cipher Algorithm
            </div>
            <div className="font-mono text-slate-300 truncate">{algorithm}</div>
          </div>

          <div className="p-3 bg-[#090D12] border border-slate-800/80 rounded-lg space-y-1">
            <div className="text-slate-500 flex items-center gap-1.5 font-medium">
              <HardDrive className="w-3.5 h-3.5" /> Key Derivation
            </div>
            <div className="font-mono text-slate-300 truncate">{kdf}</div>
          </div>
          ...
          <div className="p-3 bg-[#090D12] border border-slate-800/80 rounded-lg space-y-1">
            ...
            <div className="font-mono text-slate-300">{formatDateTime(timestamp)}</div>
          </div>
        ...
        {/* Checksum Box */}
        <div className="p-3 bg-[#090D12] border border-slate-800 rounded-lg space-y-1.5">
          <div className="flex items-center justify-between text-xs">
            <span className="text-slate-500 font-medium">SHA-256 Integrity Checksum</span>
            <button
          ...
          <p className="font-mono text-[11px] text-slate-300 bg-black/40 p-2 rounded border border-slate-800 break-all select-all">
            {checksum}
          </p>
        </div>
        ...
        {outputPath && (
          <div className="text-xs text-slate-400 flex items-center justify-between px-1">
            ...
            <span className="font-mono text-slate-300">{outputPath}</span>
          </div>
        )}
      </div>
    </Modal>
