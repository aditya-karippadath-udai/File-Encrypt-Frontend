...
export const BatchProgressCard: React.FC = () => {
  ...
  return (
    <div className="p-5 bg-gradient-to-b from-[#0F172A]/80 to-[#0D1117] border border-blue-900/30 rounded-2xl shadow-xl space-y-4">
      {/* Top Header */}
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between text-xs font-mono">
          <span className="text-slate-400 font-sans">Overall Progress</span>
          <span className="text-blue-400 font-bold">{overallPercent}%</span>
        </div>
        <ProgressBar
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-1 border-t border-slate-800/80 text-xs">
        <div className="flex items-center gap-2 p-2 bg-[#090D12]/70 rounded-lg border border-slate-800/60">
          <Clock className="w-3.5 h-3.5 text-blue-400 shrink-0" />
          <div className="min-w-0">
            <div className="text-[10px] text-slate-500 uppercase tracking-wider">Active/Waiting</div>
        ...
        <div className="flex items-center gap-2 p-2 bg-[#090D12]/70 rounded-lg border border-slate-800/60">
          ...
          <div className="min-w-0">
            ...
            <div className="font-mono font-semibold text-emerald-400">{completedCount} files</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 p-2 bg-[#090D12]/70 rounded-lg border border-slate-800/60">
          ...
          <div className="min-w-0">
            ...
            <div className="font-mono font-semibold text-red-400">{failedCount} files</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 p-2 bg-[#090D12]/70 rounded-lg border border-slate-800/60">
          ...
          <div className="min-w-0">
            <div className="text-[10px] text-slate-500 uppercase tracking-wider">Total Payload</div>
            <div className="font-mono font-semibold text-slate-200">{formatBytes(totalBytes)}</div>
          </div>
        </div>
      </div>
    </div>
