...
export const QueueItemCard: React.FC<QueueItemCardProps> = ({ operation }) => {
  ...
  return (
    <div className="p-4 bg-[#0D1117] border border-slate-800/90 rounded-xl hover:border-slate-700/80 transition-all space-y-3">
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        >
          <div className="w-9 h-9 rounded-lg bg-[#111827] border border-slate-800 flex items-center justify-center shrink-0">
            {isEnc ? (
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              <h4 className="text-xs font-semibold text-slate-100 truncate group-hover:text-blue-300 transition-colors">
                {operation.file.name}
              </h4>
              {getStatusBadge()}
            </div>
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between text-[11px]">
          ...
          <span className="font-mono font-semibold text-slate-200">{progress.percent}%</span>
        </div>
        ...
        {status === 'processing' && (
          <div className="flex items-center justify-between text-[11px] font-mono text-slate-400 pt-0.5">
            ...
            <span className="text-blue-400">{formatSpeed(progress.speedBytesPerSec)}</span>
