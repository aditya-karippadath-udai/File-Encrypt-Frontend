...
import { AppInfo, DesktopService, FileDialogOptions, HealthStatus } from './desktopService';

/**
 * Mock / Browser fallback implementation of DesktopService.
 * Enables zero-setup browser testing, previews, and graceful fallback
 * when Tauri native APIs are not present.
 */
...
export const mockDesktopService = new MockDesktopService();
