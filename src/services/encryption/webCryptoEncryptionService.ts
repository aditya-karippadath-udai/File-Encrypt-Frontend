...
export class WebCryptoEncryptionService implements EncryptionService {
  ...
  public async encryptFile(
    ...
    onProgress({
      ...
      speedBytesPerSec: 0,
      timeRemainingSec: 1,
      stageText: 'Reading source file buffer...',
    });
    ...
    onProgress({
      ...
      speedBytesPerSec: 0,
      timeRemainingSec: 1,
      stageText: 'Deriving 256-bit encryption key with PBKDF2 (100,000 iterations)...',
    });
    ...
    onProgress({
      ...
      timeRemainingSec: 1,
      stageText: 'Encrypting payload with AES-256-GCM + Poly/GCM tag...',
    });
    ...
    onProgress({
      ...
      timeRemainingSec: 1,
      stageText: 'Packaging authenticated container & calculating SHA-256...',
    });
    ...
    const outputPath = `~/Downloads/${outputName}`;

    // Trigger local download of real encrypted file
    if (file.rawFile) {
  ...
  public async decryptFile(
    ...
    if (file.rawFile) {
      ...
      throw new Error('No file data available for decryption.');
    }
    ...
    if (isAegisFormat) {
      ...
      // Raw salt (16 bytes) + IV (12 bytes) + ciphertext fallback
    ...
    onProgress({
      ...
      speedBytesPerSec: 0,
      timeRemainingSec: 1,
      stageText: 'Deriving key and verifying authentication tag...',
    });
    ...
    onProgress({
      ...
      speedBytesPerSec: 50 * 1024 * 1024,
      timeRemainingSec: 1,
      stageText: 'Authenticating MAC & decrypting payload stream...',
    });
    ...
    onProgress({
      ...
      speedBytesPerSec: 60 * 1024 * 1024,
      timeRemainingSec: 1,
      stageText: 'Verifying SHA-256 checksum and restoring file...',
    });
